...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mPress enter to back MISHU Menu ")
...
def R():
			...
			print(" [2] Create Supper File [ NO WORK ]")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[Mishu]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
    ...
    def __pler__(self):
        ...
        print(' [1] CL😊NE With Auto Pass ')

        print(' [2] CL😊NE With Name Digit Pass')
        ...
        if chi == '':
            ...
            print("\033[1;32m      __________ \033[1;37m")

            print(" [$]______________4_____4_______44_____[$]")
            ...
            print("\033[1;32m      MISHU \033[1;37m")
